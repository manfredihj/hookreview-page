...
export const LANDINGS: Record<string, Landing> = {
  "soluciones-ai-para-ecommerce": {
    ...
    description: "gofidely recupera el doble de carritos abandonados que tus campañas de email. Integración rápida y resultados medibles.",
    cta: "Agendar reunión",
    ...
    videoTitle: "Descubrí cómo funciona gofidely",
    ...
    pricingTiers: [
      {
        ...
        features: [
          "Reventa de plataforma gofidely",
  ...
  "soluciones-ai-para-restaurantes": {
    ...
    videoUrl: "https://www.loom.com/share/98ba5c9ca845499d85eb8f33b57d2c5e",
    videoTitle: "Mirá cómo funciona gofidely para gastronomía",
  ...
  "soluciones-ia-para-atencion-al-cliente": {
    ...
    description: "gofidely responde, agenda y organiza tus conversaciones por WhatsApp e Instagram, 24/7. La inteligencia artificial ya reemplaza la atención al cliente manual.",
    ...
    features: [
      ...
      },
      {
        ...
        text: "Tu negocio no duerme. Tu agente de IA tampoco. gofidely atiende por WhatsApp e Instagram, responde consultas, agenda turnos y califica leads al instante. Todo desde una bandeja unificada para vos y tu equipo."
      },
      {
      ...
      },
      {
        ...
        text: "Olvidate de abrir 3 celulares distintos. Con gofidely, toda la atención al cliente se centraliza en una sola bandeja inteligente con chat unificado, etiquetas automáticas, historial del cliente y derivaciones internas."
      }
    ],
    ctaBlock: {
